<div class="mb-4">
    ...
    <input type="{{ $type }}" value="{{ old($name) }}" name="{{ $name }}" id="{{ $id }}" placeholder="{{ $placeholder }}"
           class="@error($name) border-red-500 @enderror px-4 py-1.5 text-gray-600 form-input border-gray-300 dark:border-dark-4 input input--lg w-full border block focus:outline-none focus:border-green-500">
